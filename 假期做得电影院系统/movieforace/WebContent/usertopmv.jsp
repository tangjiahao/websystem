...
<%
    ...
    <form action="userformv?handle=searchallmv3" method="post">
    	...
    	<button type="submit">推荐电影</button>
    	 	...
    	 	<%if(request.getAttribute("pager")!=null) {%>
                 <h2>本周推荐影片</h2>
                    <div class="allmvbk">
		        	  ...
		        	  if(t.getRecommend().equalsIgnoreCase("yes")){
		              %>
		               
		                 <div class="mvbk">
		                 <a href="userformv?handle=searchplaylist&movieid=<%=t.getMovieid() %>&pageindex=1&pagesize=6">

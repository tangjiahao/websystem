...
function searchone(){
	...
	window.location.href="rootformv?handle=searchmvmessage2&moviename="+encodeURI(encodeURI(tip)); 
}
...
电影名：<input name="moviename" type="text" value="<%=mv.getMoviename() %>" onblur="searchone()" placeholder="请输入想删除的电影名"><br><br><br><br>
 <form action="rootformv?handle=deletemovie" method="post">
电影id：<input name="mvid" type="text" value="<%=mv.getMovieid()    %>" readonly="readonly" style="background-color:grey;"><br>
电影名：<input name="mvname" type="text" value="<%=mv.getMoviename() %>"  ><br>

		...
		<div id="container">
			...
			<div id="middle">
				<div id="left">
					...
					<p style="color:blue;font-size:16px; width:150px;height:150px;float:left;"><%=tip %><%=person.getUsername() %>
					<br><br><br><br>&nbsp;&nbsp;&nbsp;欢迎登录</p><br>
					</div>
						<span>功能导航</span>
					<ul>
						<li><a href="usertopmv.jsp" target="mainframe">火热推荐</a></li>
						<li><a href="usersearchallmv.jsp" target="mainframe">所有电影</a></li>
						<li><a href="usermessage.jsp" target="mainframe">个人信息</a></li>
						<li><a href="userformv?handle=userordermenu&pageindex=1&pagesize=5" target="mainframe">订单查询</a></li>
						<li><a href="moviecomment.jsp" target="mainframe">相关影评</a></li>

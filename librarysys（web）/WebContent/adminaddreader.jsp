    ...
    <div class="content">
      ...
      <!-- class="ad_data"的div中是系统管理员系统的切换部分 -->
        <div class="ad_data">
               ...
               <form action="addreadercheck" method="post">
               <div class="menu_left">
                  <div class="data"><label>借阅号</label><input type="text" name="k1"/></div>
                  <div class="data"><label>用户名</label><input type="text" name="k2"/></div>
                  <div class="data"><label>学院</label><input type="text" name="k3"/></div>
                  <div class="data"><label>专业</label><input type="text" name="k4"/></div>
                  <div class="data"><label>电话</label><input type="text" name="k5"/></div>
                  <div class="data"><label>邮箱</label><input type="text" name="k6"/></div>
                  <div class="data">
                      <label>借阅上限</label>
                      <select class="bookMax" name="k7">
                   ...
                   <div class="data" >
                      <label>借阅期限</label>
                      <select class="bookMax" name="k8">
                        <option value="30">30天</option>
                        <option value="90">90天</option>
                      </select>
                  </div>
                  <button class="add_btn" type="submit">确认加入<p style="color:red;font-size:16px;"><%=tip%></button>

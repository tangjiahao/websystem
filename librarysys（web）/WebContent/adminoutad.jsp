   ...
   <div class="ad_page">
    ...
    <div class="content">
      ...
      <!-- class="ad_data"的div中是系统管理员系统的切换部分 -->
        <div class="ad_data">
                <form action="admessagecheck" method="post">
                ...
                <form action="outreaderadcheck">
                <div class="data"><label>编号</label><input name="borrowid2" value="<%=temp.getAdid() %>" readonly="readonly"/></div>
                <div class="data"><label>用户名</label><input value="<%=temp.getAdname() %>"/></div>
                <div class="data"><label>初始密码</label><input value="<%=temp.getAdpassword() %>"/></div>
                <div class="data"><label>电话</label><input value="<%=temp.getAdphone() %>"/></div>
                <div class="data"><label>邮箱</label><input value="<%=temp.getAdemail() %>"/></div>

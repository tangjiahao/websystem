...
/**
 * Servlet implementation class adminpersonalcheck
 */
@WebServlet("/adminpersonalcheck")
public class adminpersonalcheck extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminpersonalcheck() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
        	...
        	String sql0="select * from systemadmin";
        ...
        if(flag==1)
        {
        	...
        	if(p2=="" && p3=="")
        	{
	            ...
	            try {
	                ...
	                String sql0="update systemadmin set adminname=?,adminpassword=?,adminphone=?,adminemail=? where adminid=?";
...
//	                	request.getSession().setAttribute("ufo", admin);
        	...
        	else if(p2!="" &&p2.equals(p3))
        	{
	            ...
	            try {
	                ...
	                pst.setString(4, p6);
	                pst.setString(5, adminid);
	                admin.setAdminname(p4);
	                admin.setAdminphone(p5);
	                admin.setAdminemail(p6);
	                temp=pst.executeUpdate();
	                out.print("temp");
	                out.print(temp);
	                if(temp==1)

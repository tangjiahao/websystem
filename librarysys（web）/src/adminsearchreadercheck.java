...
/**
 * Servlet implementation class adminsearchreadercheck
 */
@WebServlet("/adminsearchreadercheck")
public class adminsearchreadercheck extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public adminsearchreadercheck() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(count>0)
        {
    		...
    		try {
                ...
                request.setAttribute( "searchreader",list);

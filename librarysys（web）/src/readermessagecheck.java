...
/**
 * Servlet implementation class readermessagecheck
 */
@WebServlet("/readermessagecheck")
public class readermessagecheck extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public readermessagecheck() {
        super();

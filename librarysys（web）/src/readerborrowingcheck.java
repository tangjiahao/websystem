...
/**
 * Servlet implementation class readerborrowingcheck
 */
@WebServlet("/readerborrowingcheck")
public class readerborrowingcheck extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public readerborrowingcheck() {
        super();
...
//        ArrayList<borrowrecord> a=null;
        ...
        if(count>0)
        {
    		...
    		try {
                ...
                request.setAttribute("haveborrowed", num);
  			    request.getRequestDispatcher("readerborrowing.jsp").forward(request, response);
        ...
        {
        	 request.setAttribute("haveborrowed", 0);
        	 request.getRequestDispatcher("readerborrowing.jsp").forward(request, response);
        }
